...
<body>
    ...
    <section class="home">
        ...
        <nav>
            <ul>
                <li><a href="Recuperacion/Recuperacion.php">Problema 1</a></li>
                <li><a href="Recuperacion/Recuperacion2.php">Problema 2</a></li>
                <li><a href="Recuperacion/Recuperacion3.php">Problema 3</a></li>
            </ul>
        </nav>
    </div>
    </section>
